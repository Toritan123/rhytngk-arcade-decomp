...
| SH-4 → C (game code) | 1,411 functions translated, 1,353 rebuild byte-exactly (2.53% of code bytes) |
| SH-4 runtime libraries | 1,996 libstdc++/libsupc++/libgcc/newlib/zlib functions rebuilt from upstream source (22.69% of code bytes; with the game code, 25.05% is rebuilt from source) |
...
links GCC 4.1.2's libstdc++, libsupc++ and libgcc, newlib 1.15.0 and zlib 1.2.3. `make upstream`
