/*
 * code_0c103000.c - single-instruction leaf functions on page 0x0C103xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c103000.c`.
 */

#include "rt_types.h"

/* ---- load int at p[11] ---- */
int func_0c103f52(const int *p) { return p[11]; }

/* ---- store int at p[6] ---- */
void func_0c103f00(int *p, int v) { p[6] = v; }

/* ---- store int at p[11] ---- */
void func_0c103f44(int *p, int v) { p[11] = v; }
