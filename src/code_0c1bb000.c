/*
 * code_0c1bb000.c - leaf accessors on page 0x0C1BBxxx (-O2 region).
 *
 ...
 *
 * Verify with `python3 tools/verify_c.py src/code_0c1bb000.c`.
 *
...
/* ---- store int at p[0] ---- */
void func_0c1bb0c0(int *p, int v)
{
    p[0] = v;
}

/* ---- empty function ---- */
void func_0c1bb2a2(void)
{
}
