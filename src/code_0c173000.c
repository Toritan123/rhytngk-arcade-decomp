/*
 * code_0c173000.c - leaf accessors on page 0x0C173xxx (-O2 region).
 *
 ...
 *
 * Verify with `python3 tools/verify_c.py src/code_0c173000.c`.
 */

#include "rt_types.h"

/* ---- identity stub ---- */
void *func_0c173780(void *p)
{
    return p;
}

/* ---- tail-call through a function-pointer argument ---- */
void func_0c173fa0(void *a, void (*fn)(void *))
{
    fn(a);
}
