/*
 * code_0c0da000.c - leaf helpers on page 0x0C0DAxxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0da000.c`.
 *
...
void func_0c0da86c(void)
{
}

void func_0c0da878(void)
{
}

void func_0c0da884(void)
{
}
