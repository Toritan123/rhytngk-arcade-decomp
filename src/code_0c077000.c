/*
 * code_0c077000.c - leaf helpers on page 0x0C077xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c077000.c`.
 *
...
void func_0c07753c(void)
{
}

void func_0c077f24(void)
{
}
