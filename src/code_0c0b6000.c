/*
 * code_0c0b6000.c - leaf helpers on page 0x0C0B6xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0b6000.c`.
 *
...
void func_0c0b60b8(void)
{
}

void func_0c0b61b4(void)
{
}
