/*
 * code_0c09a000.c - leaf helpers on page 0x0C09Axxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c09a000.c`.
 *
...
void func_0c09ab44(void)
{
}

void func_0c09ab50(void)
{
}
