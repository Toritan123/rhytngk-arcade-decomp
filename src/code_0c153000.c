/*
 * code_0c153000.c - leaf helpers on page 0x0C153xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c153000.c`.
 *
...
void func_0c15358c(void)
{
}

/* ---- constant stub ---- */

int func_0c153864(void)
{
    return 1;
}

int func_0c153872(void)
{
    return 1;
}
