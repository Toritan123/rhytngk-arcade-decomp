/*
 * code_0c0d9000.c - leaf helpers on page 0x0C0D9xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0d9000.c`.
 *
...
void func_0c0d9450(void)
{
}

void func_0c0d945c(void)
{
}

void func_0c0d9488(void)
{
}
