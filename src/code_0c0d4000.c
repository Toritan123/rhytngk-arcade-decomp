/*
 * code_0c0d4000.c - leaf helpers on page 0x0C0D4xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0d4000.c`.
 *
...
void func_0c0d4324(void)
{
}

void func_0c0d4814(void)
{
}
