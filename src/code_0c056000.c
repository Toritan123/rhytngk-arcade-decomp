/*
 * code_0c056000.c - leaf helpers on page 0x0C056xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c056000.c`.
 *
...
void func_0c056f84(void)
{
}

/* ---- constant stub ---- */

int func_0c056f90(void)
{
    return 1;
}
