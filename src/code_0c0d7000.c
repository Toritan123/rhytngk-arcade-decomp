/*
 * code_0c0d7000.c - leaf helpers on page 0x0C0D7xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0d7000.c`.
 *
...
void func_0c0d739c(void)
{
}

void func_0c0d7cb4(void)
{
}

void func_0c0d7cc0(void)
{
}
