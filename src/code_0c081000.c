/*
 * code_0c081000.c - leaf helpers on page 0x0C081xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c081000.c`.
 *
...
void func_0c081748(void)
{
}

void func_0c081754(void)
{
}
