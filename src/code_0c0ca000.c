/*
 * code_0c0ca000.c - leaf helpers on page 0x0C0CAxxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0ca000.c`.
 *
...
void func_0c0ca6a0(void)
{
}

void func_0c0ca814(void)
{
}
