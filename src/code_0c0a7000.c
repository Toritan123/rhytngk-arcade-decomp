/*
 * code_0c0a7000.c - leaf helpers on page 0x0C0A7xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0a7000.c`.
 *
...
void func_0c0a7d28(void)
{
}

void func_0c0a7d34(void)
{
}
