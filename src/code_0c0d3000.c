/*
 * code_0c0d3000.c - leaf helpers on page 0x0C0D3xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0d3000.c`.
 *
...
void func_0c0d3de8(void)
{
}

void func_0c0d3e78(void)
{
}
