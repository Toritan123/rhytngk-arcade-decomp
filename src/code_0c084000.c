/*
 * code_0c084000.c - leaf helpers on page 0x0C084xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c084000.c`.
 *
...
void func_0c0842c8(void)
{
}

/* ---- store a byte through the second argument ---- */

void func_0c0843a8(void *self, u8 *p, u8 v)
{
    (void)self;
    *p = v;
}
...
void func_0c0843b6(void)
{
}

void func_0c0844a4(void)
{
}

void func_0c0844b0(void)
{
}
