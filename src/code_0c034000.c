/*
 * code_0c034000.c - leaf helpers on page 0x0C034xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c034000.c`.
 *
...
void func_0c034ff0(void)
{
}

void func_0c034ffc(void)
{
}
