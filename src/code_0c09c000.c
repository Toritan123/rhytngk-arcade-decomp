/*
 * code_0c09c000.c - leaf helpers on page 0x0C09Cxxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c09c000.c`.
 *
...
void func_0c09c714(void)
{
}

void func_0c09c720(void)
{
}
