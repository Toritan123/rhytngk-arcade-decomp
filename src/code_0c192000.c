/*
 * code_0c192000.c - leaf accessors on page 0x0C192xxx (-O2 region).
 *
 ...
 *
 * Verify with `python3 tools/verify_c.py src/code_0c192000.c`.
 */

#include "rt_types.h"

/* ---- tail-call through a function-pointer argument ---- */
void func_0c192e40(void *a, void (*fn)(void *))
{
    fn(a);
}
void func_0c192f80(void *a, void (*fn)(void *))
{
    fn(a);
}
