/*
 * code_0c0ed000.c - leaf helpers on page 0x0C0EDxxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0ed000.c`.
 *
...
void func_0c0edca0(void)
{
}

/* ---- constant stub ---- */

int func_0c0edcac(void)
{
    return 0;
}
