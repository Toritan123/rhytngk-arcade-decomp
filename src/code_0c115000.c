/*
 * code_0c115000.c - leaf accessors on page 0x0C115xxx (-O2 region).
 *
 ...
 *
 * Verify with `python3 tools/verify_c.py src/code_0c115000.c`.
 */

#include "rt_types.h"

/* ---- load int at p[1] ---- */
int func_0c115920(const int *p)
{
    return p[1];
}
int func_0c115ea0(const int *p)
{
    return p[1];
}
