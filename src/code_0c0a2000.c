/*
 * code_0c0a2000.c - leaf helpers on page 0x0C0A2xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0a2000.c`.
 *
...
void func_0c0a28de(void)
{
}

void func_0c0a2d84(void)
{
}

void func_0c0a2fb4(void)
{
}
