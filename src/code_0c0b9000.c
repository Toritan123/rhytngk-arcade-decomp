/*
 * code_0c0b9000.c - leaf helpers on page 0x0C0B9xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0b9000.c`.
 *
...
void func_0c0b9b18(void)
{
}

void func_0c0b9b24(void)
{
}
...
void func_0c0b9b3c(void)
{
}

void func_0c0b9b88(void)
{
}

/* ---- store a byte through the second argument ---- */

void func_0c0b9e50(void *self, u8 *p, u8 v)
{
    (void)self;
    *p = v;
}
