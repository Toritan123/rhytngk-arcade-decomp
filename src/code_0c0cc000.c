/*
 * code_0c0cc000.c - leaf helpers on page 0x0C0CCxxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0cc000.c`.
 *
...
void func_0c0cc01c(void)
{
}

void func_0c0cc028(void)
{
}
