/*
 * code_0c0ab000.c - leaf helpers on page 0x0C0ABxxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0ab000.c`.
 *
...
void func_0c0ab01c(void)
{
}

void func_0c0ab4ec(void)
{
}
