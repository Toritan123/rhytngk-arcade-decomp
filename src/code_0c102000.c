/*
 * code_0c102000.c - leaf helpers on page 0x0C102xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c102000.c`.
 *
...
void func_0c1023b4(void)
{
}

/* ---- constant stub ---- */

int func_0c10255c(void)
{
    return 1;
}
