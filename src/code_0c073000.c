/*
 * code_0c073000.c - leaf helpers on page 0x0C073xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c073000.c`.
 *
...
void func_0c073710(void)
{
}

void func_0c073e58(void)
{
}

void func_0c073ec0(void)
{
}
