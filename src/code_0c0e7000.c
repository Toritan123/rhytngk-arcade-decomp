/*
 * code_0c0e7000.c - leaf helpers on page 0x0C0E7xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c0e7000.c`.
 *
...
void func_0c0e76f0(void)
{
}

void func_0c0e7c70(void)
{
}

void func_0c0e7c7c(void)
{
}
