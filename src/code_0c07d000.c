/*
 * code_0c07d000.c - leaf helpers on page 0x0C07Dxxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c07d000.c`.
 *
...
void func_0c07d6a8(void)
{
}

void func_0c07d6b4(void)
{
}

void func_0c07de2c(void)
{
}
