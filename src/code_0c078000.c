/*
 * code_0c078000.c - leaf helpers on page 0x0C078xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c078000.c`.
 *
...
void func_0c078110(void)
{
}

void func_0c078bac(void)
{
}

void func_0c078d98(void)
{
}
