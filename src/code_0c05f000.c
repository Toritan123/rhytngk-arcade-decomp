/*
 * code_0c05f000.c - page 0x0C05Fxxx.
 *
...
extern void func_0c05d6f0(void *);
extern void func_0c05f304(void *);

void func_0c05fa94(s32 initialize, s32 priority)
{
    if (initialize == 1) {
        if (priority == 0xFFFF) {
            func_0c030b28((void *)0x0C4E9444);
            func_0c05f304((void *)0x0C4E9338);
        }
    } else if (initialize == 0) {
        if (priority == 0xFFFF) {
            func_0c05d6f0((void *)0x0C4E9338);
            func_0c031108((void *)0x0C4E9444);
        }
    }
}

void func_0c05fafc(void)
{
    func_0c05fa94(0, 0xFFFF);
}

void func_0c05fb20(void)
{
    func_0c05fa94(1, 0xFFFF);
}
