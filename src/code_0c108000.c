/*
 * code_0c108000.c - single-instruction leaf functions on page 0x0C108xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c108000.c`.
 */

#include "rt_types.h"

/* ---- constant stub ---- */
int func_0c108874(void) { return 0; }
int func_0c1088e0(void) { return 0; }
int func_0c1088ee(void) { return 0; }
