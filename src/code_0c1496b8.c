/* LANG: c++ */
/*
 * code_0c1496b8.c - implicit destructors of classes at the root of their hierarchy.
 *
...
class FileHndlInterface {
public:
    virtual ~FileHndlInterface();
};
FileHndlInterface::~FileHndlInterface()
{
}
