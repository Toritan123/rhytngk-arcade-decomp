/*
 * code_0c04e000.c - leaf helpers on page 0x0C04Exxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c04e000.c`.
 *
...
void func_0c04e1f8(void)
{
}

void func_0c04e204(void)
{
}
