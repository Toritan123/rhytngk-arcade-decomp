/*
 * code_0c079000.c - leaf helpers on page 0x0C079xxx.
 *
 ...
 * (see ./Dockerfile).  Verify with `python3 tools/verify_c.py src/code_0c079000.c`.
 *
...
void func_0c0794f0(void)
{
}

void func_0c0794fc(void)
{
}

void func_0c079de4(void)
{
}
